...
@section('body')
    <div class="row">
        ...
        <form method="POST" action="{{route('admin.users.balance.saveBalanceImport')}}" accept-charset="UTF-8"
              id="import_form" class="form-horizontal">
            <input type="hidden" class="_token" value="{{ csrf_token() }}">
            <div class="col-md-8">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="col-sm-4 control-label">批量导入余额：</label>
                    <div class="col-sm-8">
