...
class OrdersController extends Controller
{
	...
	public function __construct(OrderRepository $orderRepository, OrderItemRepository $orderItemsRepository)
	{
	...
	public function index()
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($orders, $view, $freightCompany, $more_filter) {
			...
			$content->body(view('store-backend::point_mall.orders.index', compact('orders', 'view', 'freightCompany', 'more_filter')));
		});
	}
	...
	public function show($id)
	{
		...
		return LaravelAdmin::content(function (Content $content) use ($order, $order_deliver, $shipping, $adjustments, $orderPoint, $orderConsumePoint, $supplierIds, $isSupplier) {
			...
			$content->body(view('store-backend::point_mall.orders.show', compact('order', 'order_deliver', 'orderGoods', 'shipping', 'adjustments', 'orderPoint', 'orderConsumePoint', 'supplierIds', 'isSupplier')));
		});
	}
