...
class GoodsPurchaseEventListener
{
	...
	public function subscribe($events)
	{
		$events->listen(
			...
			'GuoJiangClub\EC\Open\Backend\Store\Listeners\GoodsPurchaseEventListener@purchaseRecordOnOrderSubmitted'
		);

		$events->listen(
			'purchase.record.on.order.cancel',
			'GuoJiangClub\EC\Open\Backend\Store\Listeners\GoodsPurchaseEventListener@purchaseRecordOnOrderCancel'
		);
	}
}