...
use GuoJiangClub\EC\Open\Backend\Store\Model\RefundShipping;
...
use GuoJiangClub\EC\Open\Backend\Store\Repositories\RefundRepository;
use GuoJiangClub\Component\Refund\Service\RefundService as BaseRefundService;
...
class RefundService
{
	...
	public function __construct(OrderRepository $orderRepository,
	                            ...
	                            \GuoJiangClub\Component\Payment\Services\RefundService $paymentRefundService)
	{
	...
	{
		$refund = $this->refundRepository->find($id);
		//!settings('enabled_pingxx_pay') AND
	...
	protected function originalRefund($refund, $refundAmount)
	{
		...
		$type        = $order->type == 11 ? 'activity' : 'order';

		$result = $this->paymentRefund->createRefund($order->order_no, $paymentLog->transcation_order_no, $refund->refund_no, $paymentLog->amount, $refundAmount->amount, $paymentLog->channel, $description, $type);
