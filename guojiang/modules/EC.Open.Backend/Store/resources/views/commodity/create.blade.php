...
<div class="tabs-container" id="wizard">
    <ul class="nav nav-tabs">
        <li class="active"><a data-id="1" class="app-action" aria-expanded="true">款式信息（SPU）<i class="glyphicon"></i></a>
        </li>
        <li class=""><a data-id="2" class="app-action" aria-expanded="false">规格信息（SKU）<i class="glyphicon"></i></a></li>
        <li class="editor_li"><a data-id="3" class="app-action" data-type="ue" aria-expanded="false">详细描述(Mobile)</a>
        </li>
        <li class="editor_li"><a data-id="4" class="app-action" data-type="uepc" aria-expanded="false">详细描述(PC)</a></li>
    ...
    <div class="tab-content items">
        ...
        <div class="tab-pane" id="tab_6">
            ...
            <div class="app-actions">
                ...
                <input type="submit" class="btn btn-success app-action-save" data-toggle="form-submit"
                       data-target="#base-form" value="保存">
            </div>
        </div><!-- /.tab-pane -->
