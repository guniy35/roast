...
<div class="tabs-container">
    ...
    <ul class="nav nav-tabs">
        <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true"> 编辑新人进店礼（{{$gift_new_user->name}}
                ）</a></li>
    </ul>
    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                <div class="row">
                    {!! Form::open( [ 'url' => [route('admin.promotion.gift.new.user.api.update',['id'=>$gift_new_user->id])], 'method' => 'POST', 'id' => 'gift_new_user_form','class'=>'form-horizontal'] ) !!}
                    ...
                    <div class="form-group" style="display:none;">
                        <label class="col-sm-2 control-label">赠送优惠券(进行中的)：</label>
                        <div class="col-sm-10">
