    ...
    <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                <div class="row">
                    {!! Form::open( [ 'url' => [route('admin.promotion.gift.new.user.store')], 'method' => 'POST', 'id' => 'gift-new-user-form','class'=>'form-horizontal'] ) !!}
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date form_datetime">
                                ...
                                <input type="text" class="form-control" name="ends_at"
                                       value="{{empty($s_time)?date("Y-m-d H:i:s",time()+60*60*24*30):$e_time}}"
