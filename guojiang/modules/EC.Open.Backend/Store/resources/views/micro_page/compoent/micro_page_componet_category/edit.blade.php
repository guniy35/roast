                        ...
                        <ul id="bar" style="margin-left: -50px;">
                            ...
                            @if($advertItems->count())
                                @foreach($advertItems as $key=> $item)
                                    ...
                                    <li class="advert_li clearfix advert_li_{{$key+1}}" index="{{$key+1}}" data-category_id="{{$item->associate->id}}" >
                                        <div class="del">
                                        ...
                                        <div class="box_input_group">
                                            <div class="box_input">
                                                ...
                                                <div>{{$item->associate->name}}</div>
                                            </div>
                                            <div class="box_input">
                                                <label class="text-right">数量:</label>
                                                <div><input class='form-control' type='number' name='limit' placeholder='前端显示的商品数量' value="{{$item->meta['limit']}}"></div>
                                            </div>
                                            <div class="box_input">
                                                <label class="text-right">名称:</label>
                                                <div><input class='form-control'  type='text' name='name' placeholder='前端显示的名称' value='{{$item->meta['name']}}'></div>
                                            </div>
                                        </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-2">
                        <button class="btn btn-primary" type="" id="save" is_show_title="{{$advert->is_show_title}}" onclick="save('edit')">保存</button>
                    </div>
                </div>
