        ...
        <div class="ibox-content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6" >
                        <select id="model"  class="form-control" name="model">
                            <option value ="micro_page_componet_goods_group" selected >默认</option>
                            <option value ="micro_page_componet_goods_group_change">换一换</option>
                        </select>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group advert">
                    <label class="col-sm-2 control-label text-right">*商品分组:</label>
                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="addGoodsGroup()">  添加一个{{$header}}</span>
