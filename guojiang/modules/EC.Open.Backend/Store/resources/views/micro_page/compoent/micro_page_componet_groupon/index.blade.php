        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-sm-4">
                        <a target="_blank" href="{{route('admin.setting.micro.page.compoent.create',['type'=>$type,'header'=>'拼团'])}}" class="btn btn-w-m btn-info">创建拼团模块</a>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="col-sm-3">拼团商品</th>
                        <th class="col-sm-2">拼团活动</th>
                        <th class="col-sm-1">成团人数</th>
                        <th class="col-sm-1">拼团价</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach($item->item as $citem)
                                        ...
                                        @if($citem->associate AND $citem->associate->status)
                                            <div>
                                                <a href="{{route('admin.promotion.multiGroupon.edit',$citem->associate->id)}}" target="_blank">
                                                    {{$citem->associate->title}}
                                                </a>
                                                (活动{{$citem->associate->status_text}})
                                            </div>
                                        @endif
                                ...
                                <td>
                                    <a
                                            ...
                                            href="{{route('admin.setting.micro.page.compoent.edit',['type'=>$type,'code'=>$item->code,'header'=>'拼团'])}}">
