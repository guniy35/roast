        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-sm-4">
                        <a target="_blank" href="{{route('admin.setting.micro.page.compoent.create',['type'=>$type,'header'=>'商品分组'])}}" class="btn btn-w-m btn-info">创建商品分组模块</a>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="col-sm-3">分组名称</th>
                        <th class="col-sm-3">数量</th>
                        <th class="col-sm-1">模式</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($item->type=='micro_page_componet_goods_group')
                                        默认
                                    @elseif($item->type=='micro_page_componet_goods_group_change')
                                        换一换
                                    @endif
                                ...
                                <td>
                                    ...
                                    <a
                                            ...
                                            href="{{route('admin.setting.micro.page.compoent.edit',['type'=>$type,'code'=>$item->code,'header'=>'商品分组','model'=>$item->type])}}">
