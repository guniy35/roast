...
@section('body')
    ...
    <div class="row">
        ...
        <form class="form-horizontal"  action="{{route('admin.setting.micro.page.compoent.getSuitsData')}}" method="get" id="search_spu_from">

            <div class="col-md-12">
                <div class="form-group">
                    <label for="exampleInputEmail1" class="col-sm-3 control-label"> 套餐名称:</label>
                    <div class="col-sm-7">
                ...
                @else
                    @if(request('suit_id'))
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="col-sm-3 control-label"></label>
                            <div class="col-sm-6">
                                <span class="label label-default">suit_id：{{request('suit_id')}};不存在</span>
                            </div>
                        </div>
                    @endif
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive col-sm-9" id="pagesList" data-suit_id="{{request('suit_id')}}">
...
@section('footer')
    ...
    <button type="button" onclick="sendIds();"  class="ladda-button btn btn-primary" > 确定
        <script>
            ...
            function cancel() {
                var suit_id=$('#app').attr('data-suit_id');
                if(!suit_id){
            ...
            function sendIds() {
                ...
                var data = {
                    price : $('#suit_id_'+suit_id).data('price'),
                    title : $('#suit_id_'+suit_id).data('title'),
                    img : $('#suit_id_'+suit_id).data('img'),
                    count:$('#suit_id_'+suit_id).data('count')
                };
                ...
                compoent_componet_html=compoent_componet_html.replace('{#count#}',data.count);
            ...
            $(document).ready(function () {
                ...
                $.get('{{route('admin.setting.micro.page.compoent.getSuitsData',['suit_id'=>request('suit_id')])}}', data, function (ret) {
                    ...
                    success: function (result) {
                        ...
                        kkpager.generPageHtml({
                            ...
                            click:function(n){
                                ...
                                $.get("{{route('admin.setting.micro.page.compoent.getSuitsData')}}?page="+n,data, function(data){
                                    $("#pagesList").html("");
                                    $("#pagesList").html(data);
