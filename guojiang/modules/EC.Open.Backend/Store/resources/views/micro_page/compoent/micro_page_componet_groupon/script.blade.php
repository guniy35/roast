<script>
    ...
    function addGroupon() {
        ...
        var url = "{{route('admin.setting.micro.page.compoent.model.groupons')}}"
...
<script>
    ...
    function save(action){
        ...
        $('.advert_li').each(function (v, obj) {
            ...
            var id=obj.attr('data-groupon_id');

             data[v]['associate_id']=id;

             data[v]['associate_type']='groupon';
        ...
        if(JSON.stringify(data) == "{}"){
            ...
            swal("保存失败!", '请添加拼团商品', "error");return;
        }
