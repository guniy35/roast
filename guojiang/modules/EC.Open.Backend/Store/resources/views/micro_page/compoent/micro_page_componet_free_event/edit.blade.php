    ...
    <div class="ibox-content">
            ...
            <div class="panel-body">
                ...
                <div class="form-group advert">
                    <label class="col-sm-2 control-label text-right">*集call活动:</label>
                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                            ...
                            @if($advertItems->count())
                                @foreach($advertItems as $key=> $item)
                                    ...
                                    @if($item->associate AND $item->associate->status)
                                          <li class="advert_li clearfix advert_li_{{$key+1}}" index="{{$key+1}}" data-free_event_id="{{$item->associate->id}}" >
                                <div class="del">
                                ...
                                <div class="box_input_group">
                                    ...
                                    <div class="box_input">
                                        ...
                                        <div>¥{{$item->associate->per_count}}</div>
                                    </div>
                                    <div class="box_input">
                                        <label class="text-right"></label>
                                        @if($item->associate->status==3)
                                            (活动已失效)
                                        @else
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="addFreeEvent()">  添加一个{{$header}}活动</span>
                                </a>
                            </li>
...
@include('store-backend::micro_page.compoent.micro_page_componet_free_event.script')
