<script>
    var compoent_html = ["  <li class=\"advert_li clearfix\" >",
        ...
        "<a class='edit'   style='cursor: pointer'  href='javascript:;'  data-type='{#type#}' data-subtitle='{#subtitle#}'  data-ids='{#ids#}' data-name='{#name#}' data-index='{#index#}' >编辑</a>" +
        "<input class='form-control' name='goods_ids' type='hidden' value='{#goods_ids#}'>" +
        "<input class='form-control' name='group_subtitle' type='hidden' value='{#group_subtitle#}'>" +
        "</label>",
        "                                </div>",
        "                               </div>",
        "                            </li>"].join("");
...
<script>
    ...
    $('body .advert').on('click','.edit',function () {
        ...
        var subtitle=that.data('subtitle');
        ...
        ['type'=>'micro_page_componet_goods_group'])}}"+'&goods_ids='+goods_ids+'&title='+title+'&subtitle='+subtitle+'&index='+index;
        ...
        ['type'=>'micro_page_componet_goods_group_img'])}}"+'&title='+title+'&subtitle='+subtitle+'&index='+index+'&input='+JSON.stringify(input);
    ...
    function save(action){
        ...
        $('#bar .advert_li').each(function (v, obj) {
            ...
            var subtitle=obj.find('input[name=group_subtitle]').val();
            ...
            if(type=='micro_page_componet_goods_group'){
                ...
                data[v]['meta']=JSON.stringify({"count":ids_arr.length,'goods_ids':ids,'subtitle':subtitle});
                ...
                if(typeof(input)!='undefined'){
                    ...
                    data[v]['meta']=JSON.stringify({"count":len,"input":input,'subtitle':subtitle});
