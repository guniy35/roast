                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                            ...
                            @if($advertItems->count())
                                ...
                                @foreach($advertItems as $key=> $item)
                                    ...
                                    @if($item->associate AND $item->associate->status)
                                        ...
                                        <li class="advert_li clearfix advert_li_{{$key+1}}" index="{{$key+1}}" data-seckill_id="{{$item->associate->id}}" >
                                        <div class="del">
                                        ...
                                        <div class="box_input_group">
                                            ...
                                            <div class="box_input">
                                                <label class="text-right">秒杀价:</label>
                                                <div>¥{{$item->associate->seckill_price}}</div>
                                            </div>
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="addSeckill()">  添加一个{{$header}}商品</span>
                                </a>
                            </li>
...
@include('store-backend::micro_page.compoent.micro_page_componet_seckill.script')
