                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="add('bar',compoent_like_html)"> 添加封面</span>
                                </a>
                            </li>
                            <p style="margin-left: -35px;">*猜你喜欢商品数据取自推荐商品，请自行设置商品为推荐</p>
                            <p style="margin-left: -35px;">*建议图片尺寸165*218像素</p>
                        </ul>
...
@include('store-backend::micro_page.compoent.micro_page_componet_guess_like.script')
