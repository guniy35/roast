    ...
    <div class="ibox-content">
            ...
            <div class="panel-body">
                ...
                <div class="form-group advert">
                    <label class="col-sm-2 control-label text-right">*拼团商品:</label>
                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                            ...
                            @if($advertItems->count())
                                @foreach($advertItems as $key=> $item)
                                    ...
                                    @if($item->associate AND $item->associate->status)
                                        <li class="advert_li clearfix advert_li_{{$key+1}}" index="{{$key+1}}" data-groupon_id="{{$item->associate->id}}" >
                                <div class="del">
                                ...
                                <div class="box_input_group">
                                    <div class="box_input">
                                        <label class="text-right">商品:</label>
                                        <div>{{$item->associate->goods->name}}</div>
                                    </div>
                                    <div class="box_input">
                                        <label class="text-right">成团数:</label>
                                        <div>{{$item->associate->number}}</div>
                                    </div>
                                    <div class="box_input">
                                        <label class="text-right">拼团价:</label>
                                        <div>¥{{$item->associate->price}}</div>
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="addGroupon()">  添加一个{{$header}}商品</span>
                                </a>
                            </li>
...
@include('store-backend::micro_page.compoent.micro_page_componet_groupon.script')
