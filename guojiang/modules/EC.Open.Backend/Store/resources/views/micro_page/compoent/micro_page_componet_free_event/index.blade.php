        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                ...
                <div class="row" style="margin-bottom:20px;">
                    ...
                    <div class="col-sm-4">
                        <a target="_blank" href="{{route('admin.setting.micro.page.compoent.create',['type'=>$type,'header'=>'集call'])}}" class="btn btn-w-m btn-info">创建集call模块</a>
                    </div>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="col-sm-3">集call活动名称</th>
                        <th class="col-sm-3">集call数量</th>
                            ...
                            <tr>
                                    ...
                                    @if($item->item->count())
                                        ...
                                        @foreach($item->item as $ck=> $citem)
                                            ...
                                            @if($citem->associate AND $citem->associate->status)
                                                ...
                                                <a href="{{route('admin.free.event.edit',$citem->associate->id)}}" target="_blank">{{$citem->associate->title}}</a>


                                                 @if($citem->associate->status==3)
                                                    (活动已失效)
                                                 @else
                                ...
                                <td>
                                    <a
                                            ...
                                            href="{{route('admin.setting.micro.page.compoent.edit',['type'=>$type,'code'=>$item->code,'header'=>'集call活动'])}}">
