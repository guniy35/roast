...
<script>
    ...
    $("body .advert").on("click", ".link-input", function () {
        ...
        if (type_s.val() == 'brand_detail') {
            ...
            var new_url = url + '?index=' + index + '&brand_id=' + val;
    ...
    function add(id, str) {
        ...
        $('.advert_li').eq(num - 1).find('.inputName').addClass('inputName-' + num);
        $('.advert_li').eq(num - 1).find('.inputName').data('index', num);
