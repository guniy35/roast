<script>
    ...
    function addFreeEvent() {

        var url = "{{route('admin.setting.micro.page.compoent.model.freeEvents')}}"
...
<script>
    ...
    function save(action){
        ...
        $('.advert_li').each(function (v, obj) {
            ...
            data[v]['type']='freeEvent';

            var id=obj.attr('data-free_event_id');

             data[v]['associate_id']=id;

             data[v]['associate_type']='freeEvent';
        ...
        if(JSON.stringify(data) == "{}"){
            ...
            swal("保存失败!", '请添加集call活动', "error");return;
        }
