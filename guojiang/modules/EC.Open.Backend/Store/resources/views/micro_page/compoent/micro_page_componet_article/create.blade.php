    ...
    <div class="ibox-content">
        <div class="ibox-content">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label text-right">排列样式</label>

                    <div class="col-sm-6" >
                        <select id="style"  class="form-control" name="style">
                            <option value ="micro_page_componet_article_-" selected >竖排</option>
                            <option value ="micro_page_componet_article_|">横排</option>
                        </select>
                    </div>
            ...
            <div class="panel-body">
                ...
                <div class="form-group advert">
                    <label class="col-sm-2 control-label text-right">*文章:</label>
                    ...
                    <div class="col-sm-8 col-lg-5 advert-box">
                        ...
                        <ul>
                            <li class="advert_b_li">
                                <a class="fa fa-plus">
                                    <span onclick="addArticles()">  添加一个{{$header}}</span>
                                </a>
                            </li>
