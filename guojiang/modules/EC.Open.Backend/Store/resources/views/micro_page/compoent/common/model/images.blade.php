...
@section('body')
    ...
    <div class="panel-body">
        ...
        <input  type="text" id="group_subtitle" name="group_subtitle" value="{{request('subtitle')}}" class="form-control" placeholder="小标题"
                style="margin-bottom: 10px;margin-top: 10px;margin-left: 12px;width:520px;">
                                    ...
                                    <div class="box_input_group">
                                        ...
                                        <div class='box_input'>
                                            ...
                                            <select class="form-control type-s" name="type">
                                                ...
                                                <option value="brand_detail"  @if($item->type=='brand_detail') selected  @endif data-page="/pages/brand/brandList/brandList?id=">品牌详情页</option>
                                            </select>
                                        ...
                                        <div class='box_input link-input'
                                             ...
                                             @if(!in_array($item->type,['store_list','store_detail','other_micro','other_links','other','brand_detail']))
                                        ...
                                        >
                                            ...
                                            <input type="text" class="form-control  inputLink inputLink-{{$key+1}}"  data-index="{{$key+1}}"
                                                   ...
                                                   @if(in_array($item->type,['store_list','store_detail','other_micro','brand_detail']))
    ...
    <button type="button" onclick="saveImg();" class="ladda-button btn btn-primary"> 确定
        ...
        <script>
            var compoent_images_html = ["  <li class=\"advert_li advert_li_ clearfix\">",
                ...
                "                                        <option value=\"brand_detail\" data-page=\"/pages/brand/brandList/brandList?id=\">品牌详情页</option>",
                "                                    </select>",
            ...
            $("body .advert").on("click", ".link-input", function () {
                ...
                //选择品牌页面
                if (type_s.val() == 'brand_detail') {

                    var url = "{{route('admin.setting.micro.page.compoent.model.brands')}}"

                    var new_url = url + '?index=' + index + '&brand_id=' + val+'&type='+'micro_page_componet_goods_group_img';
            ...
            function saveImg(){
                ...
                var subtitle=$('#group_subtitle').val();
                ...
                compoent_componet_html = compoent_componet_html.replace('{#subtitle#}',subtitle);

                compoent_componet_html = compoent_componet_html.replace('{#group_subtitle#}',subtitle);
