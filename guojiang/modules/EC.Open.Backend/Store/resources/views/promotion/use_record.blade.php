                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="btn-group">
                                <button class="ladda-button btn btn-primary" id="coupons_use_export"
                                        data-style="slide-right">导出
                                </button>
                            </div>
                            <div class="btn-group">
                                    ...
                                    @if($coupons->count()>0)
                                        ...
                                        @foreach ($coupons as $coupon)
                                            <tr class="coupon{{$coupon->id}}">
                                                ...
                                                <td>{{GuoJiangClub\EC\Open\Backend\Store\Model\ElDiscount::find($coupon->discount_id)->title}}</td>
                                                <td>{{$coupon->code}}</td>
