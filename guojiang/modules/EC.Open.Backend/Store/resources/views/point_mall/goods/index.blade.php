...
<div class="tabs-container">
    <ul class="nav nav-tabs">
        <li class="{{ Active::query('view',0) }}"><a no-pjax
                                                     href="{{route('admin.point-mall.goods.index',['view'=>0])}}"> 上架商品
                <span class="badge">{{$allCount}}</span></a></li>
        <li class="{{ Active::query('view',2) }}"><a no-pjax
                                                     href="{{route('admin.point-mall.goods.index',['view'=>2])}}"> 已下架商品
                <span class="badge">{{$delCount}}</span></a></li>
    </ul>
        ...
        <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
                <div class="row">
                    <div class="col-md-10">
                        <div class="btn-group">
                            <a class="btn btn-primary " href="{{ route('admin.point-mall.goods.create') }}">添加商品</a>
                        </div>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="{{ route('admin.goods.uplode_inventorys') }}">批量导入库存</a></li>
                                ...
                                <tr class="goods{{$item->id}}" gid="{{$item->id}}">
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-primary"
                                           href="{{route('admin.point-mall.goods.edit',['id'=>$item->id,'redirect_url'=>urlencode(Request::getRequestUri())])}}">
                                            <i data-toggle="tooltip" data-placement="top"
                                               class="fa fa-pencil-square-o"
                                               title="编辑"></i></a>
                                        <a target="_blank" data-method="delete" class="btn btn-xs btn-danger"
                                           href="{{route('admin.goods.destroy',['id'=>$item->id])}}">
                                            <i data-toggle="tooltip" data-placement="top"
                                               class="fa fa-trash"
                                               title="删除"></i></a>
                                    </td>
