...
<ul class="nav nav-tabs">
    <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">款式信息（SPU）</a></li>
    <li class=""><a href="#tab_3" data-toggle="tab" aria-expanded="false">规格信息（SKU）</a></li>
...
<div class="tab-content">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    ?>
                    <input name="is_del" type="radio" value="0" {{$del_sel}} /> 是
            ...
            <div class="form-group" id="integral_form" style="display: {{$goods_info->is_largess == 1?'block':'none'}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    @if(!empty($point))
                        ...
                        @else
                            <input type="radio" class="form-control" name="point_type" value="0"> 固定值
    ...
    <div class="tab-pane" id="tab_9">
        <div class="panel-body">
            ...
            <div class="form-group">
                <input type="hidden" name="extra[video][url]" value="{{$goods_info->extra->video->url or ''}}">
