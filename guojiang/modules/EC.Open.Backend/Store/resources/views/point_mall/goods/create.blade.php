...
{!! Html::script(env("APP_URL").'/assets/backend/libs/md5.js') !!}
...
<style type="text/css">
    ...
    div#containerpc,div#container{overflow: hidden}
    #sku-table input[type=file]{    display: inline-block;
        margin-top: 10px;}

    #sku-table th{min-width: 90px}
    #sku-table th.sku-th{min-width: 170px}
    #sku-table input{width: 100%}
...
<div class="tabs-container">
    <ul class="nav nav-tabs">
        ...
        <li class="editor_li"><a href="#tab_2" data-toggle="tab" data-type="ue"  aria-expanded="false">详细描述(Mobile)</a></li>
        <li class="editor_li"><a href="#tab_6" data-toggle="tab" data-type="uepc"  aria-expanded="false">详细描述(PC)</a></li>
        <li class="editor_li"><a href="#tab_8" data-toggle="tab" data-type="ue_collocation"  aria-expanded="false">推荐搭配</a></li>
    ...
    {!! Form::open( [ 'url' => [route('admin.goods.store')], 'method' => 'POST', 'id' => 'pointMall-base-form','class'=>'form-horizontal'] ) !!}
    <div class="tab-content">
        ...
        <div class="tab-pane active" id="tab_1">
            <div class="panel-body">
                ...
                <div class="form-group" style="display: none;">
                    ...
                    <div class="col-sm-10">
                        <input name="is_largess" type="radio" value="1" checked/> 是
                        <input name="is_largess" type="radio" value="0" /> 否
                    </div>
                </div>

                <div class="form-group" id="integral_form" style="display: block">
        ...
        @include('store-backend::point_mall.goods.includes.album')
        ...
        <div class="tab-pane" id="tab_7">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-sm-2 control-label">参与积分：</label>
                    <div class="col-sm-10">
                        <input type="radio" class="form-control" name="point_status" value="0" checked="checked">
                        不参与
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="radio" class="form-control" name="point_type" value="0" checked="checked"> 固定值
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="point_value" value="0">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="radio" class="form-control" name="extra[video][status]" value="0" checked="checked"> 禁用
                    </div>
                </div>
        ...
        success: function (result) {
            if (!result.status) {
                ...
                swal({
                    ...
                    location = '{{route('admin.point-mall.goods.index')}}';
                });
            }
