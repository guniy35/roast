...
@if($refund->status == 7)
    <div class="form-group">
        <label class="control-label col-lg-2">处理：</label>
        <div class="col-lg-9">
            <select name="express" class="form-control" style="color: black;">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-9">
            <input class="form-control" name="number" placeholder="" style="color: black;">
        </div>
    </div>
@endif
...
{{--AND settings('enabled_pingxx_pay')--}}
@if($refund->status==8 AND $refundAmount)
    <div class="form-group">
...
--}}
                <option value="wechat" selected>自动转账到用户微信钱包</option>

            </select>

            <div class="alert alert-danger" style="margin-top: 10px" id="channel_tips">
                系统将自动打款至用户的微信钱包账户,请谨慎操作
            </div>
        </div>
    </div>
