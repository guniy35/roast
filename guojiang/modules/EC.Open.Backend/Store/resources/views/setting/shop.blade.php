        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_1">
                <div class="panel-body">
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">会员卡logo:</label>
                        <div class="col-sm-10">
                            <input type="hidden" name="member_card_logo" value="{{settings('member_card_logo')?settings('member_card_logo'):''}}">
                            <img class="member_card_logo" src="{{settings('member_card_logo')?settings('member_card_logo'):''}}" alt="" style="max-width: 100px;">
                            <div id="memberCardLogoPicker">选择图片</div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-group"><label class="col-sm-2 control-label">分享订单文案:</label>
                        <div class="col-sm-10"><input type="text" name="share_order_title"
                                                      placeholder="如：分享了一个订单，来自ibrand商城"
                                                      class="form-control"
                                                      value="{{settings('share_order_title')}}"></div>
                    </div>
            ...
            <div class="tab-pane" id="tab_4">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">发布圈子是否审核：</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">圈子评论是否需要审核：</label>

                        <div class="col-sm-10">
                            <label class="control-label">
                                <input type="radio" value="1"
                                       name="travel_comment_publish_audit" {{settings('travel_comment_publish_audit') ? 'checked': ''}}>
                                是
                                &nbsp;&nbsp;
                                <input type="radio" value="0"
                                       name="travel_comment_publish_audit" {{!settings('travel_comment_publish_audit') ? 'checked': ''}}>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">发布圈子获得积分：</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">点赞圈子获得积分：</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">是否启用自定义微页面：</label>

                        <div class="col-sm-10">
                            <label class="control-label">
                                <input type="radio" value="1"
                                       name="other_micro_page" {{settings('other_micro_page') ? 'checked': ''}}>
                                是
                                &nbsp;&nbsp;
                                <input type="radio" value="0"
                                       name="other_micro_page" {{!settings('other_micro_page') ? 'checked': ''}}>
...
<script>
    ...
    $(function () {
	    ...
	    //会员卡logo
	    var memberCardLogoPicker = WebUploader.create({
		    auto: true,
		    swf: '{{url(env("APP_URL").'/assets/backend/libs/webuploader-0.1.5/Uploader.swf')}}',
		    server: '{{route('file.upload',['_token'=>csrf_token()])}}',
		    pick: '#memberCardLogoPicker',
		    fileVal: 'file',
		    accept: {
			    title: 'Images',
			    extensions: 'gif,jpg,jpeg,bmp,png',
	    ...
	    memberCardLogoPicker.on('uploadSuccess', function (file, response) {
		    var img_url = response.url;

		    $('input[name="member_card_logo"]').val(img_url);
		    $('.member_card_logo').attr('src', img_url);
	    });
