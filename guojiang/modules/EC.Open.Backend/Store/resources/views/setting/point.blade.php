<div class="ibox float-e-margins">
    <div class="ibox-content" style="display: block;">
        <form method="post" action="{{route('admin.setting.saveShopSetting')}}" class="form-horizontal"
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">小程序分享商品获得积分：</label>

                <div class="col-sm-10">
                    <label class="control-label">
                        <input type="text" class="form-control valid-num"
                               value="{{settings('share_goods_point_value')?settings('share_goods_point_value'):0}}"
                               name="share_goods_point_value" placeholder="小程序分享商品获得积分">
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">签到规则文案：</label>

                <div class="col-sm-10">
                   <textarea class="form-control" name="sign_rule">{!! settings('sign_rule')?settings('sign_rule'):'请完善签到规则' !!}</textarea>
                </div>
            </div>
