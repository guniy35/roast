                ...
                <div class="form-group sku-box-spu" style="display: block">
                    ...
                    <div class="col-sm-10">
                        <table class="table table-bordered" id="discount-table-spu">
                            ...
                            <tbody>
                            <tr class="showData">
                                <input type="hidden" id="item_type_spu" name="item_type" class="form-control"
                                       value="spu">
                                <input type="hidden" id="item_id_spu" name="item_id" class="form-control" value="1">

                                <td><input type="number" name="quantity_spu" class="form-control" value="1"
                                           disabled="disabled"></td>
                                <td><input type="text" name="origin_price_spu" class="form-control" value=""
                                           disabled="disabled"></td>
                ...
                <div class="form-group sku-box" style="display:none">
                    ...
                    <div class="col-sm-10">
                        <table class="table table-bordered" id="discount-table">
                            ...
                            <tr class="showData">
                                <td><input type="text" name="sku" class="form-control" value="" disabled="disabled">
                                </td>
                                <td><input type="number" name="quantity" class="form-control" value="1"
                                           disabled="disabled"></td>
                                <td><input type="text" name="origin_price" class="form-control" value=""
                                           disabled="disabled"></td>
