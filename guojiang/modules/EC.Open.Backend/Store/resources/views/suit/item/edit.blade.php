                ...
                <div class="form-group sku-box-spu" style="display: block">
                    ...
                    <div class="col-sm-10">
                        <table class="table table-bordered" id="discount-table-spu">
                            ...
                            <tr class="showData">
                                @if($suits->item_type=='sku')
                                    <td><input type="text" class="form-control" value="{{$suits->product->sku}}"
                                               disabled="disabled"></td>
                                @else
                                    <td><input type="text" class="form-control" value="{{$suits->item_id}}"
                                               disabled="disabled"></td>
                                @endif
                                <td><input type="number" name="quantity" class="form-control"
                                           value="{{$suits->quantity}}" disabled="disabled"></td>
                                <td><input type="text" name="origin_price" class="form-control"
                                           value="{{$suits->origin_price}}" disabled="disabled"></td>
                                <td><input type="text" name="package_price" class="form-control"
                                           value="{{$suits->package_price}}"></td>
