...
<div class="tabs-container">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="{{ Active::query('status','nstart') }}"><a no-pjax
                                                              href="{{route('admin.promotion.suit.index',['status'=>'nstart'])}}">
                未开始
                <span class="badge"></span></a></li>
        <li class="{{ Active::query('status','ing') }}"><a no-pjax
                                                           href="{{route('admin.promotion.suit.index',['status'=>'ing'])}}">
                进行中
                <span class="badge"></span></a></li>
        <li class="{{ Active::query('status','end') }}"><a no-pjax
                                                           href="{{route('admin.promotion.suit.index',['status'=>'end'])}}">
                已结束
                <span class="badge"></span></a></li>
    </ul>
                            ...
                            @foreach($suits as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="btn btn-xs btn-danger del-suit"
                                              data-url="{{route('admin.promotion.suit.delete',['id'=>$item->id])}}">
