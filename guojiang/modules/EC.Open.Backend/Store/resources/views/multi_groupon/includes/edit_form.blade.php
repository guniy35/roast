{!! Form::open( [ 'url' => [route('admin.promotion.multiGroupon.update')], 'method' => 'POST', 'id' => 'base-form','class'=>'form-horizontal'] ) !!}
...
<div class="form-group">
    <div class="col-sm-10">
        <div class="row">
            ...
            <div class="col-sm-6">
                <p id="name">
                    <a href="{{route('admin.goods.edit',$groupon->goods_id)}}"
                       target="_blank">{{$groupon->goods->name}}</a>
                </p>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <div class="input-group m-b">
            <input class="form-control" type="text" name="rate" value="{{$groupon->rate}}">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="title" placeholder="" value="{{$groupon->title}}"/>
    </div>
</div>
...
<div class="form-group" id="two-inputs">
    ...
    <div class="col-sm-4">
        <div class="input-group date form_datetime">
            ...
            <input type="text" name="starts_at" class="form-control inline" id="date-range200" size="20"
    ...
    <div class="col-sm-4">
        <div class="input-group date form_datetime">
            ...
            <input type="text" name="ends_at" class="form-control inline" id="date-range201" size="20"
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="sort" value="{{$groupon->sort}}"/>
    </div>
</div>
