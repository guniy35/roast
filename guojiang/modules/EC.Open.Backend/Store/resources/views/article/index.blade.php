<div class="ibox float-e-margins">
    <div class="ibox-content">
        <a href="{{ route('admin.store.article.create') }}" class="btn btn-primary margin-bottom" no-pjax>添加文章</a>
            <div>
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        @foreach($articles as $article)
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary" href="{{route('admin.store.article.edit',['id'=>$article->id])}}">
                                    <i data-toggle="tooltip" data-placement="top" class="fa fa-pencil-square-o" title="" data-original-title="编辑"></i></a>
                                <a class="btn btn-xs btn-danger article-delete" data-url="{{ route('admin.store.article.delete', ['id'=>$article->id]) }}">
    ...
    <script>
        ...
        $('.switch').on('click', function () {
	        ...
	        var that = $(this);
	        $.post("{{route('admin.store.article.status')}}",
		        {
			        status: value,
			        modelId: modelId
		        },
