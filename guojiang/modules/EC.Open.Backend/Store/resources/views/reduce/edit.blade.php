    ...
    <div class="ibox-content" style="display: block;">
        <div class="row">
            ...
            <div class="panel-body">
                @if($type=='show')
                    @include('store-backend::reduce.includes.show_form')
                @else
                    @include('store-backend::reduce.includes.edit_form')
                @endif
...
@include('store-backend::reduce.scripts')
<script>
    $(function () {
        var status ="{{$reduce->edit_status}}";
        var type ="{{$type}}";
