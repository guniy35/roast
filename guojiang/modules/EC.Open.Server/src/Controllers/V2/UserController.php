...
class UserController extends Controller
{
    ...
    public function ucenter()
    {
        ...
        return $this->success(compact('newCount', 'paidCount', 'deliveredCount', 'receiveCount', 'favCount', 'addressCount', 'couponCount', 'point', 'balance'));
    }
    ...
    public function pointList()
    {
        ...
        $list = $this->pointRepository->getPointsByConditions($where);
