...
namespace GuoJiangClub\Component\Gift\Services;

use Carbon\Carbon;
use GuoJiangClub\Component\User\Models\User;
use GuoJiangClub\Component\Gift\Repositories\OrderRepository;
...
class DirectionalCouponService
{
    ...
    public function searchUserByCustom($input, $count = true)
    {
        ...
        if ($count) return count($user_num);
        return $user_num;
    }
    ...
    public function getUserID($input)
    {
        ...
        if (count($user_id) != $input['number'] AND count($user_id) > $input['number']) {
