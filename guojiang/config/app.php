...
return [
	...
	*/
	...
	'providers' => [
		...
		GuoJiangClub\Component\Recharge\RechargeServiceProvider::class,

		GuoJiangClub\Distribution\Backend\Providers\DistributionBackendProvider::class,
		GuoJiangClub\Distribution\Server\Providers\DistributionServiceProvider::class,
		GuoJiangClub\Distribution\Core\Providers\DistributionCoreServiceProvider::class,

		GuoJiangClub\Discover\Backend\Providers\BackendServiceProvider::class,
		GuoJiangClub\Discover\Core\Providers\CoreServiceProvider::class,
		GuoJiangClub\Discover\Server\Providers\ServerServiceProvider::class,
		GuoJiangClub\Component\Seckill\SeckillServiceProvider::class,
		GuoJiangClub\Component\Suit\Providers\SuitServiceProvider::class,
	],
